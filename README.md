...
| # | 方向 | 产出文件 | 做什么 |
|---|------|---------|--------|
| 1 | 拆解爆款 | `爆款拆解.md` | 拆对标视频/评论区，找可复用的爆款模板 |
| 2 | 商家档案 | `商家档案.md` | 聊清楚「这家店是谁、卖什么」 |
| 3 | 客群画像 | `客群画像.md` | 搞清楚「客户是谁、怎么打动」 |
| 4 | 账号定位 | `账号定位.md` | 抖音/小红书/视频号的人设与定位 |
| 5 | 内容矩阵 | `内容矩阵.md` | 各账号发什么、多久发一次 |
| 6 | 选题策划 | `选题清单.md` | 一批能直接开拍的选题 |
| 7 | 脚本撰写 | `脚本.md` | 完整、可拍的视频脚本 |
| 8 | 分镜设计 | `分镜表.md` | 脚本拆成现场可执行的镜头表 |
| 9 | 拍摄方案 | `拍摄方案.md` | 照着就能执行的拍摄安排 |
